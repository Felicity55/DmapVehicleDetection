...
if __name__=="__main__":
    ...
    img_root=r"C:\Users\CVPR\source\repos\ShanghaiTech_Crowd_Counting_Dataset\part_A_final\train_data\images"
    gt_dmap_root=r"C:\Users\CVPR\source\repos\ShanghaiTech_Crowd_Counting_Dataset\part_A_final\train_data\ground_truth"
    dataset=CrowdDataset(img_root,gt_dmap_root,4)
    dataloader=torch.utils.data.DataLoader(dataset,batch_size=1,shuffle=True)

    test_img_root=r"C:\Users\CVPR\source\repos\ShanghaiTech_Crowd_Counting_Dataset\part_A_final\test_data\images"
    test_gt_dmap_root=r"C:\Users\CVPR\source\repos\ShanghaiTech_Crowd_Counting_Dataset\part_A_final\test_data\ground_truth"
    ...
    for epoch in range(0,200):
        ...
        torch.save(mcnn.state_dict(),'./vehicle/checkpoints/epoch_'+str(epoch)+".param")
