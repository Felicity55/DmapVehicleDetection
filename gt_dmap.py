...
from k_nearest_gaussian_kernel import density_map_generator
from segmentmap import segment_map_generator
from matplotlib import pyplot as plt


# Global variables
citycam_dir = r'D:\CityCam'
test_train_sep_dir = os.path.join(citycam_dir, 'D:/CityCam/train_test_separation')
downtown_train_path = os.path.join(test_train_sep_dir, 'D:/CityCam/train_test_separation/Downtown_Train.txt')
downtown_test_path = os.path.join(test_train_sep_dir, 'D:/CityCam/train_test_separation/Downtown_Test.txt')
parkway_train_path = os.path.join(test_train_sep_dir, 'D:/CityCam/train_test_separation/Parkway_Train.txt')
parkway_test_path = os.path.join(test_train_sep_dir, 'D:/CityCam/train_test_separation/Parkway_Test.txt')
...
def _make_density_map(frame_dir):
    ...
    for frame in frame_list:
        ...
        if frame_format == 'xml':
            ...
            try:
                img_shape, points = _parse_xml(os.path.join(frame_dir, frame))
                density_map = segment_map_generator(img_shape, points)
